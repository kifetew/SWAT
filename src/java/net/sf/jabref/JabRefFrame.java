...
public class JabRefFrame extends JFrame implements OutputPrinter {
  ...
  AbstractAction
      ...
      consolidate = new GeneralAction("consolidate", "Consolidate a folder",
               Globals.lang("Consolidate a folder"),
               prefs.getKey("Consolidate a folder")),
      shrink = new GeneralAction("shrink", "Shrink a bib file",
                       Globals.lang("Shrink a bib file"),
                       prefs.getKey("Shrink a bib file")),         
    ...
    protected void initActions() {
        ...
        openDatabaseOnlyActions.addAll(Arrays.asList(new Object[] { manageSelectors,
            ...
            incrementalSearch, replaceAll, importMenu, exportMenu, fetchCiteSeer,
                openPdf, openUrl, consolidate, shrink, openFile, openSpires, togglePreview, dupliCheck, /*strictDupliCheck,*/ highlightAll,
